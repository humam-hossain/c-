...
int main()
{
    ...
    ofstream file1("../data/array1_selectionSort.txt");
    file1 << check(array1, n);
    file1.close();

    n = sizeof(array2) / sizeof(array2[0]);
    ofstream file2("../data/array2_selectionSort.txt");
    file2 << check(array2, n);
    file2.close();

    n = sizeof(array3) / sizeof(array3[0]);
    ofstream file3("../data/array3_selectionSort.txt");
    file3 << check(array3, n);
    file3.close();

    n = sizeof(array4) / sizeof(array4[0]);
    ofstream file4("../data/array4_selectionSort.txt");
